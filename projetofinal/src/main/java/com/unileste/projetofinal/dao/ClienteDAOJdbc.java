...
public class ClienteDAOJdbc implements ClienteDAO {
    ...
    public void salvar(Cliente cliente) throws Exception {
        String sql = "INSERT INTO clientes (cpf, nome, endereco) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE nome = VALUES(nome), endereco = VALUES(endereco)";
    ...
    @Override
    public void deletar(String cpf) throws ClienteNaoEncontradoException {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            if (rowsAffected == 0) {
                throw new ClienteNaoEncontradoException("Cliente com CPF " + cpf + " não encontrado para exclusão.");
            }
        } catch (SQLException e) {
    ...
    public void salvar(Conta conta) throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            if (conta instanceof ContaCorrente) {
                ...
                stmt.setDouble(5, 0.0);  // Poupança não tem limite
            }
            stmt.executeUpdate();
        }
    }
